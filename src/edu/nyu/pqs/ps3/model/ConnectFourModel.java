...
public class ConnectFourModel {
    ...
    public static class Builder {
        ...
        public Builder setTokensNeededToWin(int val) {
            if (val < 0)
                throw new IllegalArgumentException("Tokens to win cannot be less than 0");
            tokensToWin = val;
            return this;
        }
    ...
    /**
     * @return Currents the list of players in the game
     */
     ...
     * @throws IllegalArgumentException if insertion happens in a full column or invalid column
     */
    ...
    private boolean checkDiagonally(int row, int col, int element) {
        ...
        int leftCount = 1;
        int rightCount = 1;
        int minRow = row - tokensToWin > 0 ? row - tokensToWin : 0;
        for (int curr_row = row - 1; curr_row > minRow; curr_row--) {
